...
import pandas as pd
orfcolors = pd.read_csv('./SPAN/resources/colorcode-rainbow.txt', sep=' ', names=['orf', 'color'], index_col=0)['color'].to_dict()
...
plt.tight_layout()
plt.savefig(FileNamePrefix + "sgRNA_precentage.pdf")

...
```{r}
Fig4 <- ggarrange(fullA, fullB, fullC, fullD, legend="right", common.legend = TRUE, ncol = 1, nrow = 4, labels = c("A","B","C","D"))
ggsave(file.path("./Figure 4. The noncanonical subgenomic RNAs distribution plot from four different variants compared to Omicron variant.pdf"), Fig4, width = 14.8, height = 21, units = "cm")

Fig5 <- ggarrange(Omicron_plot, full, ncol = 1, nrow = 2, labels = c("A","B"))
ggsave(file.path("./Figure 5_v2. Profiling of noncanonical subgenomic RNAs form different SARS-CoV-2 Omicron lineages.pdf"), Fig5, width = 14.8, height = 14.8, units = "cm")
```
